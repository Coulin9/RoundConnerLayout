package com.android.roundconnerlayout
...
class RoundConLayout(context: Context,attrs:AttributeSet):FrameLayout(context, attrs) {
    ...
    init {
        ...
        mPath=Path()
        val typedArray=context.obtainStyledAttributes(attrs,R.styleable.RoundConnerLayout)
        mRadius=typedArray.getFloat(R.styleable.RoundConnerLayout_radius,0F)
        mLTRadius=typedArray.getFloat(R.styleable.RoundConnerLayout_left_top_radius,0F)
        mLBRadius=typedArray.getFloat(R.styleable.RoundConnerLayout_left_bottom_radius,0F)
        mRTRadius=typedArray.getFloat(R.styleable.RoundConnerLayout_right_top_radius,0F)
        mRBRadius=typedArray.getFloat(R.styleable.RoundConnerLayout_right_bottom_radius,0F)
